...
class Walker {
  ...
  createWalker() {
    strokeWeight(1);
    // stroke(map(this.x,-width,width,0,50),map(this.y,0,height,155,0),map(this.x+this.y,0,width+height,155,255),70);
    stroke(50, 50);
    this.X = map(noise(sin(this.x * 0.005), this.y * 0.005), 0, 1, -4, 4);
